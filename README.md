# Awesome Opus 5.5 Demo

[![Awesome](https://awesome.re/badge.svg)](https://awesome.re)
[![License: CC0-1.0](https://img.shields.io/badge/License-CC0%201.0-lightgrey.svg)](LICENSE)

> A curated list of **Claude Opus 5.5** demos — games, interactive 3D, films, agents, and showcases — collected from GitHub, X, and Hacker News.

**Claude Opus 5.5** launched on **2026-09-22** as the first model in Anthropic’s Claude 5.5 family. Within days, builders shipped playable Three.js games, cinematic browser films, multi-agent harnesses, and same-prompt A/B benches against competing frontier models. This list tracks the most interesting public demos.

*Claude Opus 5.5 演示精选 — 游戏、3D、影像与 Agent 作品合集。*
...
- [Rain on Glass](https://rain-on-glass-production.up.railway.app) — Interactive foggy-window rain scene. [X post](https://x.com/HixonStudio/status/2102511610518774178).
